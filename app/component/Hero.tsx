...
export default function Hero() {
 ...
 return (
  <section className="relative flex flex-col items-center justify-center text-center mt-32 px-4 overflow-hidden min-h-[60vh]">
   {/* Background Elements */}
   ...
   <div className="relative z-10 flex flex-col items-center">
    ...
    <h1 className="text-5xl md:text-7xl font-black tracking-tight mb-6 leading-tight">
     <span className="block text-black [-webkit-text-stroke:1px_black] animate-fade-in-up delay-100 opacity-0" style={{ animationFillMode: 'forwards' }}>Find trusted student</span>
     <span className="block text-black [-webkit-text-stroke:1px_black] animate-fade-in-up delay-150 opacity-0" style={{ animationFillMode: 'forwards' }}>services</span>
     <span className="block animate-fade-in-up delay-200 opacity-0" style={{ animationFillMode: 'forwards' }}>
      <span className="text-orange-500 [-webkit-text-stroke:1px_#FC6520] relative inline-block">
       on your campus
    ...
    <p className="text-black max-w-2xl mb-10 text-lg font-semibold animate-fade-in-up delay-500 opacity-0" style={{ animationFillMode: 'forwards' }}>
     Barbers, tutors, photographers, makeup artists, designers, trainers and more — verified students only.
    </p>

    <div className="flex flex-col sm:flex-row gap-4 animate-fade-in-up delay-500 opacity-0" style={{ animationFillMode: 'forwards' }}>
     <button className="bg-orange-500 text-white px-8 py-3 rounded-full font-semibold hover:bg-orange-600 transition-all flex items-center justify-center gap-2 shadow-lg hover:shadow-orange-500/30 hover:-translate-y-1 transform duration-200 group mb-3">
